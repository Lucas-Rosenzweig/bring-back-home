...
Le goal est terminé lorsque la bibliothèque et la CLI exécutent le même chemin FRLG sur transport live et replay, que les résultats `.pk3` ne sont exposés qu’après commit, que les erreurs et annulations restaurent correctement la radio, que les tests automatisés acceptés passent et que trois échanges AX200 consécutifs satisfont la procédure matérielle documentée. Le cœur LDN historique et le mode d’observation UDP/12345 doivent conserver leur comportement, et le guide d’extension doit empêcher de promouvoir PIA/RFU dans le noyau commun sans preuve issue d’un second jeu.
